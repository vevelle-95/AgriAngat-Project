  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 36 }}>
      ...
      <Text style={styles.bodyText}>
        Your account is now ready. Start exploring Marketplace and AgriAngat tools to grow your
        business, and connect with new opportunities.
      </Text>
      ...
      Tip: Learn from the Study Hub to make the most of your AgriAngat journey.
      </Text>
    </ScrollView>
  );
}
